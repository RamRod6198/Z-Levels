...
namespace ZLevels
{
    internal class SectionLayer_LowerTerrain : SectionLayer
    {
        ...
        public override void Regenerate()
        {
            ...
            var lowerMap = ZTracker.GetMapByIndex(base.Map.Tile, 0);
            if (lowerMap != null && ZTracker.GetZIndexFor(base.Map) > 0)
            {
                base.ClearSubMeshes(MeshParts.All);
                TerrainGrid terrainGrid = lowerMap.terrainGrid;
                    ...
                    if (base.Map.terrainGrid.TerrainAt(intVec) == ZLevelsDefOf.ZL_OutsideTerrain)
                    {
                        ...
                        for (int i = 0; i < 8; i++)
                        {
                            ...
                            else
                            {
                                ...
                                Thing edifice = c.GetEdifice(lowerMap);
